...
Before installing **Gerow**, ensure that your server meets the following requirements:
...
**Gerow** is based on our **Botble CMS**, check this video to see how to install it on hosting.
...
- Run `php artisan cms:theme:activate gerow`.
...
::: warning
Since Gerow is based on the Laravel framework, its root folder is `/public`. If you're installing it in a sub-folder,
